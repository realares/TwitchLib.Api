...
namespace TwitchLib.Api.Core.Undocumented
{
    ...
    {
        public Undocumented(ILogger<Undocumented> logger, IApiSettings settings, IRateLimiter rateLimiter, IHttpCallHandler http) : base(logger, settings, rateLimiter, http)
        {
        }
