...
namespace TwitchLib.Api.Helix
{
    ...
    public class Analytics : ApiBase
    {
        ...
        public Task<GetGameAnalyticsResponse?> GetGameAnalyticsAsync
            (string? gameId = null, DateTime? startedAt = null, DateTime? endedAt = null,
            int first = 20, string? after = null, string? type = null, string? accessToken = null)
        {
        ...
        public Task<GetExtensionAnalyticsResponse?> GetExtensionAnalyticsAsync(
            string extensionId, DateTime? startedAt = null, DateTime? endedAt = null, int first = 20, string? after = null, string? type = null, string? accessToken = null)
        {
            var getParams = new List<KeyValuePair<string, string>>
         {
               new KeyValuePair<string, string>("first", first.ToString())
